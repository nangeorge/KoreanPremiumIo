          ...
          {editingNick ? (
            <>
              ...
              <button
                ...
                className="text-[var(--fg-muted)] text-xs px-1"
              >
                ✕
              </button>
            </>
            ...
            <>
              <span className="text-xs text-[var(--fg-muted)]">{t.nickname}:</span>
              <span className="text-xs font-medium text-white">{nickname}</span>
              <button
                onClick={() => { setNickInput(nickname); setEditingNick(true); }}
                className="ml-auto text-[10px] text-[var(--fg-muted)] hover:text-[var(--fg-secondary)] transition-colors"
              >
                ✏️ {t.changeNick}
              </button>
            </>
                  ...
                  <div
                    className={cn(
                      ...
                      isMe
                        ...
                        : "rounded-tl-sm bg-white/8 text-[var(--fg)]"
                    )}
                  >
                    {msg.text}
                  </div>
